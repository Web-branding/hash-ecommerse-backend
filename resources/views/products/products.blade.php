                ...
                <tbody>
                    @foreach($products as $product)
                        <tr>
                            <td>{{$product->name}}</td>
                            <td>
                            <a href="{{route('product.edit',$product->id)}}" class="btn btn-success btn-sm btn-icon-split">
                                <span class="icon text-white-50">
                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </span>
                                <span class="text">Edit</span>
                            </a>
                            <a href="{{route('product.view',$product->id)}}" class="btn btn-info btn-sm btn-icon-split">
                                <span class="icon text-white-50">
                                    <i class="fa fa-info" aria-hidden="true"></i>
                                </span>
                                <span class="text">View</span>
                            </a>
                            <button type="button" class="btn btn-danger btn-sm btn-icon-split deletebtn" value="{{$product->id}}" >
                                <span class="icon text-white-50">
