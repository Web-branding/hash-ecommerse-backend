                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('product.update',$products->id)}}" enctype="multipart/form-data">
                            ...
                            <button type="button" class="mb-3 btn bg-gradient-success border-0 text-white btn-icon-split addimg" value="{{$products->pd_id}}" >
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach($imgproducts as $product)
                                            ...
                                            @endphp
                                            <tr>
                                                <td><img src="{{asset('storage/images')}}/{{$values}}" width="200px" height="200px" alt="Image"></td>
                                                <td>
                            ...
                            <button type="button" class="mb-3 btn bg-gradient-success border-0 text-white btn-icon-split addvideo" value="{{$products->pd_id}}" >
                                <span class="icon text-white-50">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><iframe height="400"  width="400" src="{{asset('storage/videos')}}/{{$products->video}}"></iframe></td>
                                            <td>
