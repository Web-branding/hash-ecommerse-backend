                ...
                <form class="row m-3 g-3">
                    <div class="col-12">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input disabled type="text" name="place" class="form-control" id="inputPassword3" value="<?php echo e($product->price); ?>">
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <?php $__currentLoopData = $imgproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-6 mb-4">
                                    <div class="card text-white shadow">
                                        <div class="card-body">
                                            <img src="<?php echo e(asset('images/products')); ?>/<?php echo e($values); ?>" width="200px" height="200px" alt="Image">
                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6 mb-4">
                                <iframe height="400"  width="400" src="<?php echo e(asset('videos/products')); ?>/<?php echo e($product->video); ?>"></iframe>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Anju\Desktop\projects\ecomm_backend\resources\views/products/view_product.blade.php ENDPATH**/ ?>