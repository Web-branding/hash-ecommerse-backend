                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('product.update',$products->id)); ?>" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-4 col-form-label">Quantity</label>
                                <div class="col-sm-8">
                                    <input type="number" name="price" class="form-control" id="inputEmail3" required value="<?php echo e($products->price); ?>">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8">
                                    <select class="form-select col-12" name="subcategory_name" aria-label="Default select example">
                                        <?php if($products->subcategory_name == ""): ?>
                                            <option selected>---Select---</option>
                                            <?php $__currentLoopData = $subcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->subcategory_name); ?>"><?php echo e($category->subcategory_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php else: ?>
                                            <?php $__currentLoopData = $subcat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <button type="button" class="mb-3 btn bg-gradient-success border-0 text-white btn-icon-split addimg" value="<?php echo e($products->name); ?>" >
                                ...
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $imgproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <tr>
                                                <td><img src="<?php echo e(asset('images/products')); ?>/<?php echo e($values); ?>" width="200px" height="200px" alt="Image"></td>
                                                <td>
                            ...
                            <button type="button" class="mb-3 btn bg-gradient-success border-0 text-white btn-icon-split addvideo" value="<?php echo e($products->name); ?>" >
                                <span class="icon text-white-50">
                                    <i class="fa fa-plus" aria-hidden="true"></i>
                                </span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><iframe height="400"  width="400" src="<?php echo e(asset('videos/products')); ?>/<?php echo e($products->video); ?>"></iframe></td>
                                            <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Anju\Desktop\projects\ecomm_backend\resources\views/products/edit_product.blade.php ENDPATH**/ ?>